...
module.exports = function (req, res, url) {
	...
	switch (url.pathname) {
		case "/go/movie/": {
			title = "Player";
			attrs = {
				data: "https://josephcrosmanplays532.github.io/GoAnimate-Retro-Assets/animation/18/player.swf",
			...
			params = {
				flashvars: {
					...
					animationPath: "https://josephcrosmanplays532.github.io/GoAnimate-Retro-Assets/animation/18/",
					isEmbed: "0",
					refuser: null,
					utm_source: null,
					uid: null,
				...
				movie: "https://josephcrosmanplays532.github.io/GoAnimate-Retro-Assets/animation/18/player.swf",
			};
			break;
		}
